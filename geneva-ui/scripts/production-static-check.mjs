...
const BUDGETS = {
  ...
  largestCssGzipBytes: 48 * 1024,
}
const LINE_BUDGETS = new Map([
  ["geneva-ui/src/App.tsx", 1750],
  ["geneva-ui/src/components/SkillBrowser.tsx", 1150],
  ["geneva-ui/src/components/SkillModals.tsx", 500],
  ["geneva-ui/src/components/ProjectView.tsx", 1500],
  ["geneva-ui/src/components/ProjectViewSupport.tsx", 300],
  ["geneva-ui/src/components/ChatCanvas.tsx", 400],
  ["geneva-ui/src/components/ChatActivityPanel.tsx", 280],
  ["geneva-ui/src/components/ChatEmptyState.tsx", 110],
  ["geneva-ui/src/components/ChatMarkdown.tsx", 270],
  ["geneva-ui/src/components/ChatMessageBubble.tsx", 500],
  ...
  ["geneva-ui/src/lib/api/conversation-api.ts", 600],
  ["geneva-ui/src/lib/api/core.ts", 90],
  ["geneva-ui/src/lib/api/memory-api.ts", 220],
  ["geneva-ui/src/lib/api/project-api.ts", 190],
  ...
  ["geneva-ui/src/styles/project-command-surface.css", 1200],
  ["geneva-ui/src/styles/skills.css", 20],
  ["geneva-ui/src/styles/skills-control-plane.css", 2050],
  ["geneva-ui/src/styles/skills-modals.css", 330],
  ["geneva-ui/src/styles/chat.css", 1300],
  ["geneva-ui/src/styles/responsive.css", 1250],
  ["geneva-ui/src/styles/memory-browser.css", 800],
  ["geneva-ui/src/styles/composer-markdown.css", 1100],
  ["src/geneva/web_api.py", 1250],
  ["src/geneva/web_runtime.py", 1700],
  ["src/geneva/session.py", 2200],
])
